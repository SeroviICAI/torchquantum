...
from torchquantum.nn.functional import QuantumFunction, quantum_fn
import torchquantum.quantum.feature_maps as qfm
import torchquantum.quantum.variational_forms as qvf
from torchquantum.nn.init import beta_initialization
...
class QuantumLayer(nn.Module):
    ...
    Args:
        ...
        backend (optional): Quantum backend for circuit execution.
    ...
    def __str__(self) -> str:
        ...
        kernel_str = cudaq.draw(self.quantum_circuit.kernel, *params)
        return kernel_str
