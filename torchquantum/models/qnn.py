...
from torchquantum.nn.layers import QuantumLayer
...
class QNN(nn.Module):
    ...
    Args:
        ...
        num_layers (int, optional): Number of variational layers in the quantum circuit.
            Defaults to 1.
        backend (optional): Quantum backend for circuit evaluation.
...
class HybridQNN(nn.Module):
    ...
    def __init__(
        ...
        self.linear: nn.Module = nn.Linear(in_features, out_features)
        self.in_features: int = in_features
        self.out_features: int = out_features
